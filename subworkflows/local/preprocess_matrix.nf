...
include { MOM_NORM } from '../../modules/local/mom_norm'
...
workflow PREPROCESS_MATRIX {
    ...
    MOM_NORM(MOM_FILTER.out.filtered, samplesinfo, mom_norm_method, mom_norm_condition,mom_norm_treatment)
    ...
    CAT(feature,MOM_BATCH.out.cleaned)
    ch_cleaned_batch = CAT.out.cormat
    //focor = MOM_BATCH.out.cleaned
/*    if(mom_filt_run){

...
workflow QUANTIFY_SALMON {
    ...
    transcript_fasta // channel: /path/to/salmon_out
...
/*    SALMON_TXIMPORT ( SALMON_QUANT.out.results.collect{it[1]}, params.salmonsamplesinfo, gtf)
    ...
    */
    ...
    /*counts_gene                   = SALMON_TXIMPORT.out.counts
    counts_from_abundance         = SALMON_TXIMPORT.out.countsfromabundance
    salmon_dgelistRdata           = SALMON_TXIMPORT.out.salmon_dgelistRdata
    /*tpm_gene                      = SALMON_TXIMPORT.out.tpm_gene                  // channel: [ val(meta), counts ]
    counts_gene                   = SALMON_TXIMPORT.out.counts               // channel: [ val(meta), counts ]

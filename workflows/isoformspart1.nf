...
include { ISOPART1 } from '../modules/local/isopart1'
 ...
 */  
    ch_iso_part1_switchlist= ISOPART1.out.switchlist
    ch_iso_part1_nt = ISOPART1.out.nt
    ch_iso_part1_aa = ISOPART1.out.aa

process OMNIPATH_INTEGRATED {
    ...
    path input
    path input2 // genes across omics
    ...
    Rscript /r/omnipath_multi_omics_ggplot2_annotation.R $input $input2 $filter $attribute_of_column $additional_info_boolean $additional_info $additional_info_attribute
...
if (params.omnipath_integrated_alone){
    workflow{
    OMNIPATH(params.omnipath_biotrans, params.omnipath_integrated_gao, params.omnipath_choose, params.omnipath_choose_type, params.omnipath_additional_info_bool, params.omnipath_additional_info_val, params.omnipath_additional_info_attribute)
}
}